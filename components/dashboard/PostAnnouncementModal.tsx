  ...
  return (
    <>
      <button 
        ...
        className="btn btn-primary btn-sm gap-2 rounded-lg shadow-sm"
      >
          ...
          <div className="bg-base-100 rounded-2xl shadow-xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="px-6 py-4 border-b border-base-300 flex items-center justify-between bg-base-100/50">
              ...
              <button 
                ...
                className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-base-200 text-neutral transition-colors"
              >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-3 py-2 bg-base-100 border border-base-300 rounded-lg text-[14px] focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors resize-none"
                />
              </div>
